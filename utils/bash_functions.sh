...
print_version_table() {
    ...
    echo -e "\n### Versions" \
        ...
        "\n| :blossom: Flowbite   | [$FLOWBITE_CURRENT_VERSION](https://github.com/$FLOWBITE_REPOSITORY/releases/tag/v$FLOWBITE_CURRENT_VERSION) |" \
        "\n"
}
...
format_download_badge() {
    ...
    printf "[![](%s)](%s)" \
        ...
        "https://github.com/lovetodream/tailwind-flowbite-bundled-cli/releases/download/$tag/tailwindcss-flowbite-${os,,}-$arhitecture$extension"
}
